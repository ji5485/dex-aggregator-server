...
export default {
  SERVER_PORT: 5000,
  PG_DATABASE: process.env.TEST_PG_DATABASE,
  PG_USERNAME: process.env.TEST_PG_USERNAME,
  PG_PASSWORD: process.env.TEST_PG_PASSWORD,
  PG_HOST: process.env.TEST_PG_HOST,
  PG_TIMEZONE: process.env.TEST_PG_TIMEZONE,
  PG_PORT: process.env.TEST_PG_PORT,
